...
{#key isOn}
    <div on:mouseenter={entered} on:mouseleave={left} class="group nowPlayingComponent inline-flex px-3 py-1 rounded-md items-center bg-gray-100 transition-colors decoration-none dark:bg-gray-50/10 text-sm">
        {#if !song}
        ...
        {:else if song}
            {#if song.isPlaying === true}
                <div class="audio inline h-4 w-4 top-0">
                    <span></span>
                    <span></span>
                    <span></span>
                </div>
