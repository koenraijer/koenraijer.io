...
Ever since I saw <a href="https://leerob.io/">this implementation of the Spotify API in Next.js</a>, I've been wanting to do the same thing in SvelteKit. Knowing the song someone's listening to in that very moment makes an otherwise mostly static website feel very dynamic. It doesn't get more realtime than that. 
