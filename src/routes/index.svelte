...
<div class="max-w-[75ch] mx-auto px-6 md:px-8">
  ...
  <MultiSelect bind:searchText bind:selected options={post_types} ulOptionsClass="!shadow-none !bg-gray-100 !rounded-xl mt-1" liSelectedClass="inline-flex bg-gray-200 rounded-lg my-1 dark:bg-gray-50/10 py-1 px-2 mr-2" liOptionClass="hover:bg-gray-50 dark:bg-gray-50/10" outerDivClass="w-4/6 sm:w-full dark:border-gray-50/10 dark:focus-within:border-gray-200 focus-within:border-[#212121]"/>
