...
export const routes = [
	...
	[/^\/blog\/motivational-interviewing\/?$/, [c[0], c[3], c[4]], [c[1]]],

	// src/routes/blog/web-development-resources.md
	[/^\/blog\/web-development-resources\/?$/, [c[0], c[3], c[5]], [c[1]]],

	// src/routes/blog/future-proofing-research.md
	[/^\/blog\/future-proofing-research\/?$/, [c[0], c[3], c[6]], [c[1]]],

	// src/routes/blog/iterate-iterate-iterate.md
	[/^\/blog\/iterate-iterate-iterate\/?$/, [c[0], c[3], c[7]], [c[1]]],

	// src/routes/blog/lost-in-programming.md
	[/^\/blog\/lost-in-programming\/?$/, [c[0], c[3], c[8]], [c[1]]],

	// src/routes/blog/svelteKit-endpoints.md
	[/^\/blog\/svelteKit-endpoints\/?$/, [c[0], c[3], c[9]], [c[1]]],

	// src/routes/blog/endnote-tutorial.md
	[/^\/blog\/endnote-tutorial\/?$/, [c[0], c[3], c[10]], [c[1]]]
];
